...
後述の書籍「Linuxコマンド&シェル・スクリプト入門」向けのサポート・ページですが、プログラムについては書籍をお持ちで無くても活用していただけます。  
プログラムの作り方や内容の説明については、書籍の方でご覧いただければと思います。  
...
--------------------------------------------------------------------------------
## [PR] 手のひらサイズのコンピュータ「ラズベリー・パイ」で学ぶ！<br>Linuxコマンド&シェル・スクリプト入門

基本的なLinuxコマンドとシェルスクリプトを、IoTシステム・プログラムを、作りながら学べる書籍を執筆させていただきました。  
当ページは、本書向けのプログラムの配布と、本書の読者様向けの補足情報の提供を目的にしております。  
実際のプログラムの作り方や内容の説明については、書籍の方でご覧いただければと思います。  

[PR] CQ出版社の情報ページ(2025/11/5発売予定：定価2,640円): 
[https://www.cqpub.co.jp/hanbai/books/44/44801.htm](https://www.cqpub.co.jp/hanbai/books/44/44801.htm)
